...
return {
  {
    ...
    },
    {
      ...
      dependencies = { 'williamboman/mason-lspconfig.nvim', opts = { ensure_installed = mason.lsp } },
      event = 'BufEnter',
      config = function()
        ...
        for lsp, lsp_configs in pairs(servers) do
          ...
          require('lspconfig')[lsp].setup(configs)
        end
      end,
    },
  },
